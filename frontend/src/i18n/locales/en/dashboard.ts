export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your AIMate Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your AIMate Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your AIMate Grok group.',
        ...
        codexNote: 'Save config.toml under ~/.codex and set AIMATE_API_KEY before starting Codex.',
        codexNoteWindows: 'Save config.toml under %USERPROFILE%\\.codex and set AIMATE_API_KEY in PowerShell before starting Codex.',
      },
      opencode: {
