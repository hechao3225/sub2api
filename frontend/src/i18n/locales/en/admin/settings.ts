export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for AIMate end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for AIMate end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream AIMate sites connected to OpenAI API keys.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on AIMate orders; the upstream type is sent as EasyPay type.',
