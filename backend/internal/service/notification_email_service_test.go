...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "AIMate", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "AIMate", "https://example.com/reset", "en-US"))
